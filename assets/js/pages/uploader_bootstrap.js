...
$(function() {
    ...
    $('.file-input-edit').fileinput({
        ...
        initialCaption: edit_image_caption,
        // initalPreview : "<?php echo $url_image ?>",
        initialPreview: [
            // "{assets/images/placeholder.jpg}",
            edit_image_url,
        ],
        initialPreviewConfig: [
            {caption: edit_image_caption, url:edit_image_url,showDelete:false, showDrag: false},
        ],
        initialPreviewAsData: true,
        // allowedFileExtensions: ["jpg", "gif", "png", "jpeg"],
